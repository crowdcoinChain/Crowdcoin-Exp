...
QT_TRANSLATE_NOOP("dash-core", "Copyright (C) 2014-%i The Crowdcoin Core Developers"),
...
QT_TRANSLATE_NOOP("dash-core", "Error loading wallet.dat: Wallet requires newer version of Crowdcoin Core"),
...
QT_TRANSLATE_NOOP("dash-core", "Initialization sanity check failed. Crowdcoin Core is shutting down."),
...
QT_TRANSLATE_NOOP("dash-core", "Keep N CRC anonymized (default: %u)"),
...
QT_TRANSLATE_NOOP("dash-core", "Wallet needed to be rewritten: restart Crowdcoin Core to complete"),
