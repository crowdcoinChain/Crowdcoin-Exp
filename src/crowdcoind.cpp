 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Crowdcoin (https://www.dash.org/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("-h") ||  mapArgs.count("-help") || mapArgs.count("-version"))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  dashd [options]                     " + _("Start Crowdcoin Core Daemon") + "\n";
