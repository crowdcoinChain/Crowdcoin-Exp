...
dashd/dash-cli binaries are not included in the Crowdcoin-Qt.app bundle.

If you are building `dashd` or `Crowdcoin Core` for others, your build machine should be set up
