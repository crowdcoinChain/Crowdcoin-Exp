...
- [`b0843c397`](https://github.com/dashpay/dash/commit/b0843c397) Backport Bincoin PR#7348: MOVE ONLY: move rpc* to rpc/ + same for Crowdcoin-specific rpc (#1502)
...
- [`753b1e486`](https://github.com/dashpay/dash/commit/753b1e486) Eliminate remaining uses of g_connman in Crowdcoin-specific code. (#1635)
...
- [`7ab175a8e`](https://github.com/dashpay/dash/commit/7ab175a8e) Ensure Crowdcoin wallets < 0.12.2 can't open HD wallets (#1638)
